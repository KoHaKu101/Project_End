    ...
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">สั่งผลิตสื่อ</h5>
        ...
        <div class="modal-footer">
            <button type="button" class="btn btn-success" onclick="SubmitForm('form_order')" id="btn_form_order"><i class="fas fa-plus me-1"></i>สั่งผลิตสื่อ</button>
