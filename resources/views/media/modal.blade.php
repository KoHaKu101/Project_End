                    ...
                    <div class="row">
                        <div class="col-md-4 ">
                            <div class="text-center">
                                <img src="{{asset('assets/images/book_not_found.jpg')}}" width="85%" id="img_show">
                            </div>
                        </div>
                        <div class="col-md-8">
                            <div class="form-group row">
                                ...
                                <div class="col-lg-2" id="div_add_book">
                                    ...
                                    <button type="button" class="btn btn-primary btn-sm" onclick="OpenModalBook()" id="add_book"><i class="fas fa-plus me-1"></i>เพิ่มหนังสือ</button>
                                </div>
                                <div class="col-lg-4">
                                    ...
                                    <div class="form-group row" >
                                        <div class="col-md-6">
                                            <div class="input-group input-group-sm ">
                                                <input type="text" class="form-control form-control-sm" id="sound_sys" name="sound_sys" placeholder="กรอกชั่วโมง" oninput="InputOnlyNumber(this)">
                                                <span class="input-group-text">ชั่วโมง</span>
                                              </div>
                                        </div>
                                        <div class="col-md-6">
                                        <div class="input-group input-group-sm col-md-6">
                                            <input type="nubmer" class="form-control form-control-sm" id="sound_sys" name="sound_sys" placeholder="กรอกนาที" max="60" >
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <select class="form-select form-control-sm" id="select_type_file" name="select_type_file">
                                    ...
                                    <textarea class="form-control form-control-sm" id="input_textarea" name="input_textarea" placeholder="ใส่คำอธิบาย เก็บไว้ที่ไหน" rows="3"></textarea>
                                    <input type="text" class="form-control form-control-sm" id="input_text" name="input_text" placeholder="ลิงค์ google drive" hidden>
                                    <input type="file" class="form-control form-control-sm" id="input_file" name="input_file" placeholder="อัปโหลดไฟล์" hidden>
                                </div>
                                <div class="col-lg-12" id="download_file" hidden>
                                    <label id="file_name"></label>
                                    <a href="" class="btn btn-primary" id="btn_download" hidden><i class="fas fa-download"></i>download</a>
                                </div>
                            </div>
                        </div>
                    </div>
