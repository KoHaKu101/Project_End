            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    <a href="#" id="manage_data_list"
                        class="sidebar-link dropdown-list collapsed {{ $manage_data_list }} " data-bs-toggle="collapse"
                        data-bs-target="#manage_data" aria-expanded="false" aria-controls="manage_data">
                        <i class="fa-solid fa-sliders pe-2"></i>
                        <span class="text-sideBar">จัดการข้อมูลพื้นฐาน<i class="fa fa-caret-down px-2" aria-hidden="true"></i></span>
                    </a>
                    <ul id="manage_data" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#manage_data">
                        <li class="sidebar-item">
                ...
                <li class="sidebar-item">
                    <a href="#" id="copy_media_list"
                        ...
                        <span class="text-sideBar">สำเนา<i class="fa fa-caret-down px-2" aria-hidden="true"></i></span>
                    </a>
                    <ul id="copy_media" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#copy_media">
                        <li class="sidebar-item">
                ...
                <li class="sidebar-item">
                    <a href="{{ route('mediaOut.list') }}" class="sidebar-link @active('mediaOut.list') ">
                        ...
                        <span class="text-sideBar">ให้บริการสื่อ</span>
                    </a>
                </li>
                <li class="sidebar-item">
