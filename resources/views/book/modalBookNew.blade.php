<div class="modal fade" id="modal_BookNew_insert" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form method="POST" id="FormNewBook">
              @csrf
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-success" id="submitBTN" onclick="SubmitForm('FormNewBook')"><i class="fas fa-save me-1"></i>บันทึก</button>
