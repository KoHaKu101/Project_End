...
<div class="modal fade" id="modal_BookNew_insert" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <form method="POST" id="FormNewBook" enctype="multipart/form-data">
                @csrf
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-success" id="btn_submitBookNew"
                        onclick="SubmitForm('btn_submitBookNew','FormNewBook')"><i
